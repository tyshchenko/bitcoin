...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        self.nodes[0].setgenerate(True, 1) #mine a block, new tx should not be included!
        self.sync_all()
        
        self.nodes[1].setgenerate(True, 1) #mine a block, new tx should not be included!
        self.sync_all()
        ...
        #create another tx (not broadcasted)
        txIdNotBroadcasted  = self.nodes[0].sendtoaddress(self.nodes[2].getnewaddress(), 2);
        ...
        #tx should be added to the balance because after restarting the nodes the tx should be broadcastet
