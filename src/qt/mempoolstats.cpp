...
ui(new Ui::MempoolStats)
{
    ...
    QGraphicsTextItem testText("jY"); //expected 27.5 pixel in width
    testText.setFont(QFont(LABEL_FONT, LABLE_TITLE_SIZE, QFont::Light));
    qreal width = testText.boundingRect().width();
    LABLE_TITLE_SIZE *= 27.5/testText.boundingRect().width();
    LABLE_KV_SIZE *= 27.5/testText.boundingRect().width();
