...
class RequestBlockRequestTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-1, "Block not found on disk", self.nodes[1].getblock, node0bbhash, True)
        ...
        assert_raises_jsonrpc(-1, "Block not found on disk", self.nodes[1].getblock, block['previousblockhash'], True)
